...
const experiences = [
  {
    ...
    icon: Briefcase,
    certificateFile:
      "/certificates/skillcraft-certificate.pdf",
    buttonText:
...

  {
    ...
    icon: Briefcase,
    certificateFile:
      "/certificates/codsoft-certificate.pdf",
    buttonText:
      "View Internship Certificate",
  },
];
      ...
      <div className="relative mx-auto max-w-6xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-400">
            Internships and training programs that
            helped me build strong technical knowledge
        ...
        <div className="relative mt-20">
          {/* Vertical Line */}
          <div className="absolute left-6 top-0 h-full w-[2px] bg-gradient-to-b from-cyan-400 via-blue-500 to-violet-500 shadow-[0_0_10px_rgba(59,130,246,0.3)] sm:left-1/2 sm:-translate-x-1/2 md:shadow-[0_0_20px_rgba(59,130,246,0.5)]" />
                ...
                >
                  ...
                  >
                    <div className="relative">
                      {/* Outer Glow */}
                      <div className="absolute inset-0 rounded-3xl bg-cyan-400/20 blur-xl md:bg-cyan-400/30 md:blur-2xl" />

                      {/* Main Gradient Box */}
                      <div className="relative flex h-16 w-16 items-center justify-center rounded-3xl bg-gradient-to-br from-blue-500 via-violet-500 to-fuchsia-500 shadow-lg ring-1 ring-white/10 md:shadow-[0_0_35px_rgba(59,130,246,0.45)]">
                  ...
                  >
                    <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-8 shadow-lg shadow-black/20 backdrop-blur-0 md:shadow-[0_20px_60px_rgba(0,0,0,0.35)] md:backdrop-blur-xl">
                      {/* Glow */}
                      <div
                        className={`absolute -inset-px rounded-3xl bg-gradient-to-r ${item.gradient} opacity-0 blur-lg transition-opacity duration-500 md:blur-xl md:group-hover:opacity-20`}
                      />
