            ...
            <button
              ...
              className={`rounded-full px-5 py-2.5 text-sm font-medium transition-all duration-300 ${
                activeFilter === filter
                  ...
                  : "border border-white/10 bg-white/5 text-slate-300 md:hover:bg-white/10"
              }`}
            >
              {filter}
            </button>
            ...
            {filteredCategories.map(
              (category, index) => (
                ...
                >
                  {/* Glow Effect */}
                  <div
                    className={`absolute -inset-px rounded-3xl bg-gradient-to-r ${category.color} opacity-0 blur-lg transition-opacity duration-300 md:blur-xl md:group-hover:opacity-20`}
                  />
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <ArrowUpRight className="h-5 w-5 text-slate-500 transition-colors duration-300 md:group-hover:text-cyan-400" />
                    </div>
                      ...
                      {category.skills.map(
                        (skill) => {
                          ...
                          return (
                            <span
                              key={skill.name}
                              className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2 text-sm font-medium text-slate-300 transition-all duration-200 md:hover:border-cyan-400/30 md:hover:bg-cyan-400/10 md:hover:text-cyan-300"
                            >
                    ...
                    <div
                      className={`mt-8 h-1 w-20 rounded-full bg-gradient-to-r ${category.color} transition-all duration-300 md:group-hover:w-40`}
                    />
                  </div>
                </motion.div>
              )
